  ...
  return (
    <div
      className={`relative min-h-screen flex flex-col items-center justify-center transition-colors duration-300 ${
        isDark ? 'bg-[#0B0F19] text-white' : 'bg-[#eef0f5] text-black'
      }`}
    >
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Sign in to BLUEPRINTR</h1>
          <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
            Sign in to your BLUEPRINTR account to continue.
          </p>
        </div>
        ...
        <div className="space-y-3 flex flex-col items-center">
          ...
          <button
            ...
            className={`relative flex items-center justify-center w-[350px] h-[40px] rounded-full border transition-colors ${
              isDark 
                ? 'bg-[#131314] border-[#8e918f] text-[#e3e3e3] hover:bg-[#1e1e1e]' 
        ...
        {/* Footer */}
        <div className="pt-12 text-[11px] text-gray-500 max-w-[300px] mx-auto">
