...
const Sidebar = () => {
  const { isDark, toggleTheme, isSidebarOpen, toggleSidebar, userProfile, logoutUser } = useStore();
            ...
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              {isSidebarOpen && (
                <div className="flex flex-col">
                  ...
                  <span className={`text-xs truncate ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>{userProfile.email}</span>
                </div>
              )}
            </div>
            <button
